...
shell_interfaces__msg__Trajectory__init(shell_interfaces__msg__Trajectory * msg)
{
  ...
  // points
  if (!shell_interfaces__msg__TrajectoryPoint__Sequence__init(&msg->points, 0)) {
    shell_interfaces__msg__Trajectory__fini(msg);
    return false;
  }
  return true;
}
...
shell_interfaces__msg__Trajectory__fini(shell_interfaces__msg__Trajectory * msg)
{
  ...
  // points
  shell_interfaces__msg__TrajectoryPoint__Sequence__fini(&msg->points);
}
...
shell_interfaces__msg__Trajectory__are_equal(const shell_interfaces__msg__Trajectory * lhs, const shell_interfaces__msg__Trajectory * rhs)
{
  ...
  // points
  if (!shell_interfaces__msg__TrajectoryPoint__Sequence__are_equal(
  ...
  shell_interfaces__msg__Trajectory * output)
{
  ...
  // points
  if (!shell_interfaces__msg__TrajectoryPoint__Sequence__copy(
...
shell_interfaces__msg__Trajectory__create()
{
  ...
  shell_interfaces__msg__Trajectory * msg = (shell_interfaces__msg__Trajectory *)allocator.allocate(sizeof(shell_interfaces__msg__Trajectory), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shell_interfaces__msg__Trajectory));
  bool success = shell_interfaces__msg__Trajectory__init(msg);
  if (!success) {
...
shell_interfaces__msg__Trajectory__Sequence__init(shell_interfaces__msg__Trajectory__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shell_interfaces__msg__Trajectory * data = NULL;

  if (size) {
    data = (shell_interfaces__msg__Trajectory *)allocator.zero_allocate(size, sizeof(shell_interfaces__msg__Trajectory), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shell_interfaces__msg__Trajectory__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        shell_interfaces__msg__Trajectory__fini(&data[i - 1]);
      }
...
shell_interfaces__msg__Trajectory__Sequence__fini(shell_interfaces__msg__Trajectory__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      shell_interfaces__msg__Trajectory__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shell_interfaces__msg__Trajectory__Sequence * array = (shell_interfaces__msg__Trajectory__Sequence *)allocator.allocate(sizeof(shell_interfaces__msg__Trajectory__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shell_interfaces__msg__Trajectory__Sequence__init(array, size);
  if (!success) {
...
shell_interfaces__msg__Trajectory__Sequence__destroy(shell_interfaces__msg__Trajectory__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shell_interfaces__msg__Trajectory__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shell_interfaces__msg__Trajectory__Sequence__are_equal(const shell_interfaces__msg__Trajectory__Sequence * lhs, const shell_interfaces__msg__Trajectory__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shell_interfaces__msg__Trajectory__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shell_interfaces__msg__Trajectory__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shell_interfaces__msg__Trajectory);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shell_interfaces__msg__Trajectory * data =
      (shell_interfaces__msg__Trajectory *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shell_interfaces__msg__Trajectory__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shell_interfaces__msg__Trajectory__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!shell_interfaces__msg__Trajectory__copy(
