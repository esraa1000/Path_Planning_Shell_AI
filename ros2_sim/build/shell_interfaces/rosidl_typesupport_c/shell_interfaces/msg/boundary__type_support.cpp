...
static const _Boundary_type_support_symbol_names_t _Boundary_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shell_interfaces, msg, Boundary)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, shell_interfaces, msg, Boundary)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, shell_interfaces, msg, Boundary)() {
  return &::shell_interfaces::msg::rosidl_typesupport_c::Boundary_message_type_support_handle;
}
