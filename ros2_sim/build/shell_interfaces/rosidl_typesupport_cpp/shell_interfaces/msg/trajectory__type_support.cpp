...
static const _Trajectory_type_support_symbol_names_t _Trajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shell_interfaces, msg, Trajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shell_interfaces, msg, Trajectory)),
  }
};
...
{
  return &::shell_interfaces::msg::rosidl_typesupport_cpp::Trajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, shell_interfaces, msg, Trajectory)() {
  return get_message_type_support_handle<shell_interfaces::msg::Trajectory>();
}
