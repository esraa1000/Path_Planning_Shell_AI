...
#include "shell_interfaces/msg/detail/boundary__rosidl_typesupport_fastrtps_c.h"
...
using _Boundary__ros_msg_type = shell_interfaces__msg__Boundary;
...
size_t get_serialized_size_shell_interfaces__msg__Boundary(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Boundary__ros_msg_type * ros_message = static_cast<const _Boundary__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Boundary__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_shell_interfaces__msg__Boundary(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shell_interfaces
size_t max_serialized_size_shell_interfaces__msg__Boundary(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shell_interfaces__msg__Boundary;
    is_plain =
      (
...
static size_t _Boundary__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_shell_interfaces__msg__Boundary(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shell_interfaces, msg, Boundary)() {
