...
class Metaclass_Trajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('shell_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'shell_interfaces.msg.Trajectory')
            logger.debug(
            ...
            from shell_interfaces.msg import TrajectoryPoint
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        'points': 'sequence<shell_interfaces/TrajectoryPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['shell_interfaces', 'msg'], 'TrajectoryPoint')),  # noqa: E501
    )
