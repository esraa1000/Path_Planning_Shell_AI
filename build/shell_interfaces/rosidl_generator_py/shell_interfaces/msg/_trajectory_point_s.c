...
bool shell_interfaces__msg__trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shell_interfaces.msg._trajectory_point.TrajectoryPoint", full_classname_dest, 54) == 0);
  }
  shell_interfaces__msg__TrajectoryPoint * ros_message = _ros_message;
  {  // x
...
PyObject * shell_interfaces__msg__trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("shell_interfaces.msg._trajectory_point");
