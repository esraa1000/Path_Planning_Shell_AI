...
static const _ObstacleArray_type_support_symbol_names_t _ObstacleArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shell_interfaces, msg, ObstacleArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, shell_interfaces, msg, ObstacleArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, shell_interfaces, msg, ObstacleArray)() {
  return &::shell_interfaces::msg::rosidl_typesupport_c::ObstacleArray_message_type_support_handle;
}
